                    ...
                    <form action="{{route('produit.update',['produit'=> $produit])}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" placeholder="" type="number" step="0.01" min="0" id="prix_HT" name="prix_HT" value="{{ old('prix_HT', $produit->prix_HT?? null) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" placeholder="" type="number" step="0.01" min="0" id="prix_TTC" name="prix_TTC" value="{{ old('prix_TTC', $produit->prix_TTC?? null) }}">
                                <span class="fa fa-money form-control-feedback" aria-hidden="true"></span> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
