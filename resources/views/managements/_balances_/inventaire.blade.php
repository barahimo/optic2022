          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <select class="form-control" id="category">
                <option value="0" disabled="true" selected="true">-Catégorie-</option>
            ...
            <div class="col-sm-4">
              ...
              <select class="form-control" id="product">
                <option value="0" selected="true">-- Les produits --</option>
              </select>
            </div> 
          </div>
          <div class="col-sm-2"></div>
...
<script type="text/javascript">
    ...
    $(document).on('change','#category',function(){
      ...
      $.ajax({
        ...
        success:function(data){
          var options = '<option value="0" selected="true">-- Les produits --</option>';
          if(data.length>0){
  ...
  function getInventaire(){
    ...
    var link =$('#link');
    var order =$('#order');
    $('#title').html(`Balances d'inventaires : de ${format_date(date1)} à ${format_date(date2)}`);
    $.ajax({
        type:'get',
