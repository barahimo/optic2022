                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs fournisseurs </th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs clients</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs catégories</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs produits</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs achats</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs ventes</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs règlements de fournisseurs</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernièrs règlements de clients</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="col-md-6">
                <div class="table-responsive">
                    <table class="table">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th>Les {{$numberWord}} dernières factures</th>
                            </tr>
                        </thead>
                        <tbody>
